			            	...
			            	// $redacteurcode="_SESSION";
			             	 ...
			             	 if($stmt = $pdo->prepare($sql)){
			                      ...
			                      $stmt->bindParam(":lastmodification", $datereel, PDO::PARAM_STR);
			                        ...
			                        if($stmt->execute()){
			                        														return "Le Module a bien ete ajouté ";
			                        	 ...
			                        	 return "Le Module n'a pas ete ajouté, Requete Invalid veuillez retenter ";
			                        	


			                        }
			                    }else{
			                    		 return "Le Module n'a pas ete ajouté, Requete Invalid Execution Fail veuillez retenter ";
												...
												return "Le Module n'a pas ete ajouté, Requete Invalid veuillez retenter Error:".$e;
            	...
            	public function modifier($matricule,$nom,$description){
			                      ...
			                      $stmt->bindParam(":matricule", $matricule, PDO::PARAM_STR);
											            ...
											            if($stmt->execute()){
											            	...
											            	return "Le Module a ben été modifié";


											            }
											            else{
											            	return "Le Module n'a pas ete modifié correctement, Requete Invalid veuillez retenter ";
	    	            	         		...
	    	            	         		return "Le Module n'a pas ete modifié, Requete Invalid veuillez retenter Error:".$e;
...
// echo $objectCreated->modifier("6","edit nom","editdescription");
// echo $objectCreated->supprimer("6");
