  ...
  <div class="leftcolumn">
      <div class="card shadowexempl">
        ...
        <div class="container">   
          <br>   
          <div>   
            <h1>Validation d'Entrer Magasin</h1>   
            <p>Validation d'Entrer Magasin par le Gestionnaire de stock.   
            </p>   
...
// error_reporting(0);
     ...
     include('../config.php');
        ...
        echo "</br>";     
            ...
            if($page>=2){   
                echo "<a href='validationentrer.php?page=".($page-1)."'>  Prev </a>";   
            }       
                       
            for ($i=1; $i<=$total_pages; $i++) {   
              if ($i == $page) {   
                  $pagLink .= "<a class = 'active' href='validationentrer.php?page="  
                                                    .$i."'>".$i." </a>";   
              }               
              else  {   
                  $pagLink .= "<a href='validationentrer.php?page=".$i."'>   
                                                    ".$i." </a>";     
              }   
            };     
            echo $pagLink;   
            ...
            if($page<$total_pages){   
                echo "<a href='validationentrer.php?page=".($page+1)."'>  Next </a>";   
            }   
...
<script>
    function go2Page()   
        {   
            ...
            window.location.href = 'validationentrer.php?page='+page;   
        }  
