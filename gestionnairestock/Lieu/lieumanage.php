  ...
  <div class="leftcolumn">
      ...
      if(isset($_COOKIE['messagedisplay'])) : ?>
        ...
        // Import the file where we defined the connection to Database.     
            ...
            $query = "SELECT matricule, nom, description FROM lieu  LIMIT $start_from, $per_page_record";     
        ...
        <div class="container">   
          <br>   
          <div>
          <button onclick="document.getElementById('id01').style.display='block'" style="width:auto;">Ajouter Un Lieu</button>   
        ...
        <?php     
                ...
                <td>
                    <form action="lieuedit.php" method="POST"> 
                    <div class="invisi">
...
<div id="outer">
  ...
  <div class="inner"><button type="button" id="<?php echo $row["matricule"]; ?>" onclick="myFunctionDelete(this.id)">Supprimer</button></div>
        ...
        echo "</br>";     
            ...
            if($page>=2){   
                echo "<a href='lieumanage.php?page=".($page-1)."'>  Prev </a>";   
            }       
                       
            for ($i=1; $i<=$total_pages; $i++) {   
              if ($i == $page) {   
                  $pagLink .= "<a class = 'active' href='lieumanage.php?page="  
                                                    .$i."'>".$i." </a>";   
              }               
              else  {   
                  $pagLink .= "<a href='lieumanage.php?page=".$i."'>   
                                                    ".$i." </a>";     
              }   
            };     
            echo $pagLink;   
            ...
            if($page<$total_pages){   
                echo "<a href='lieumanage.php?page=".($page+1)."'>  Next </a>";   
            }   
...
<script>
    function go2Page()   
        {   
            ...
            window.location.href = 'lieumanage.php?page='+page;   
        }  
 ...
 function myFunctionDelete(elem)   
        {   
          var message=elem;
            // alert(message) ;
            window.location.href = "lieudelete.php?idcodeis="+message;
