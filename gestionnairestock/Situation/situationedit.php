      ...
      <div class="card shadowexempl">
              <div id="entrerarticle">
                  ...
                  <h5>Gestionaire de Stock Fonction</h5>
                    <form  action="../apisituation.php" method="POST">
   

    <div class="container">
            <h3>Situation Modification</h3>
      ...
      <br><label for="matricule_module"><b>Module </b></label>

      <select name="matricule_module">
                  <?php
                      include('../../db/config.php');
                      $sql = "SELECT DISTINCT nom , code FROM module";
