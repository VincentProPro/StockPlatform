...
<div id="outer">
  ...
  <div class="inner"><button type="button" id="<?php echo $row["code"]; ?>" onclick="myFunctionDelete(this.id)">Supprimer</button></div>
        ...
        echo "</br>";     
            ...
            if($page>=2){   
                echo "<a href='categorymanage.php?page=".($page-1)."'>  Prev </a>";   
            }       
                       
            for ($i=1; $i<=$total_pages; $i++) {   
              if ($i == $page) {   
                  $pagLink .= "<a class = 'active' href='categorymanage.php?page="  
                                                    .$i."'>".$i." </a>";   
              }               
              else  {   
                  $pagLink .= "<a href='categorymanage.php?page=".$i."'>   
                                                    ".$i." </a>";     
              }   
            };     
            echo $pagLink;   
            ...
            if($page<$total_pages){   
                echo "<a href='categorymanage.php?page=".($page+1)."'>  Next </a>";   
            }   
...
<script>
    function go2Page()   
        {   
            ...
            window.location.href = 'categorymanage.php?page='+page;   
        }  
 ...
 function myFunctionDelete(elem)   
        {   
          var message=elem;
            // alert(message) ;
            window.location.href = "categorydelete.php?idcodeis="+message;
