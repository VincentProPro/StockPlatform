...
<div class="navbar">
   ...
   <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="formatmanage.php">Voir </a>
      <a href="formatmanage.php">Ajouter </a>
      <a href="formatmanage.php">Modifier </a>
      <a href="formatmanage.php">Supprimer </a>
    </div>
  </div> 
  <div class="dropdown">
  ...
  <div class="leftcolumn">
      ...
      if(isset($_COOKIE['messagedisplay'])) : ?>
        ...
        // Import the file where we defined the connection to Database.     
            ...
            $query = "SELECT matricule, code, nom, description FROM format  LIMIT $start_from, $per_page_record";     
        ...
        <div class="container">   
          <br>   
          <div>
          <button onclick="document.getElementById('id01').style.display='block'" style="width:auto;">Ajouter Un Format</button>   
            <h1>Liste Des Formats</h1>   
        ...
        <?php     
                ...
                <td>
                    <form action="formatedit.php" method="POST"> 
                    <div class="invisi">
...
<div id="outer">
  ...
  <div class="inner"><button type="button" id="<?php echo $row["matricule"]; ?>" onclick="myFunctionDelete(this.id)">Supprimer</button></div>
        ...
        echo "</br>";     
            ...
            if($page>=2){   
                echo "<a href='formatmanage.php?page=".($page-1)."'>  Prev </a>";   
            }       
                       
            for ($i=1; $i<=$total_pages; $i++) {   
              if ($i == $page) {   
                  $pagLink .= "<a class = 'active' href='formatmanage.php?page="  
                                                    .$i."'>".$i." </a>";   
              }               
              else  {   
                  $pagLink .= "<a href='formatmanage.php?page=".$i."'>   
                                                    ".$i." </a>";     
              }   
            };     
            echo $pagLink;   
            ...
            if($page<$total_pages){   
                echo "<a href='formatmanage.php?page=".($page+1)."'>  Next </a>";   
            }   
...
<script>
    function go2Page()   
        {   
            ...
            window.location.href = 'formatmanage.php?page='+page;   
        }  
 ...
 function myFunctionDelete(elem)   
        {   
          var message=elem;
            // alert(message) ;
            window.location.href = "formatdelete.php?idcodeis="+message;
